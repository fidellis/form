...
const InputContainer = ({ children, error, hideError, propsContainer }) => (
  <div className="input-container" {...propsContainer}>
...
class Form extends Component {
  ...
  render() {
    return <div className="form" style={this.props.style}>{this.state.children}</div>;
  }
}
